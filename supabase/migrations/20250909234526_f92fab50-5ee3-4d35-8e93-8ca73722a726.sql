...
DROP TRIGGER IF EXISTS verificar_precos_manuais_pos_nota_trigger ON notas_imagens;
...
RAISE NOTICE 'Trigger e função problemáticos removidos, registros incorretos limpos';