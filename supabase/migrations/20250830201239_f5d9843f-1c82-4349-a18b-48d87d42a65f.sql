...
ALTER VIEW public.supermercados_publicos SET (security_barrier = true);

-- Allow authenticated users to read basic supermercado info
CREATE POLICY "Todos podem ver informações básicas dos supermercados"
