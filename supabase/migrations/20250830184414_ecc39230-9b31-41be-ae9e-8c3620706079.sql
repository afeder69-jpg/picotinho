-- Inserir supermercados de exemplo com CNPJs válidos (14 caracteres)
-- Supermercados em São Paulo
INSERT INTO public.supermercados (nome, cnpj, endereco, cidade, estado, cep, latitude, longitude, ativo)
VALUES 
  ('Carrefour SP', '45543915000181', 'Av. das Nações Unidas, 22540', 'São Paulo', 'SP', '04795-100', -23.5505, -46.6333, true),
  ('Extra Olimpia', '47508411000156', 'Av. Brigadeiro Faria Lima, 3732', 'São Paulo', 'SP', '04538-132', -23.5893, -46.6875, true),
  ('Pão Açúcar', '33041260000156', 'Av. Ibirapuera, 3103', 'São Paulo', 'SP', '04029-200', -23.5976, -46.6564, true)
