-- Função para reverter estoque ao excluir nota fiscal
...
-- Criar trigger para reverter estoque antes de excluir nota
DROP TRIGGER IF EXISTS trigger_reverter_estoque_antes_exclusao ON notas_imagens;

CREATE TRIGGER trigger_reverter_estoque_antes_exclusao
