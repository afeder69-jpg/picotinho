-- 🔒 SECURITY ENHANCEMENT: Strengthening profiles table security

-- 1. Create enhanced security functions with better validation
...
-- 2. Create security violation logging function
...
-- 3. Enhanced logging function for profile access
...
-- 4. Drop and recreate RLS policies with enhanced security
...
-- 6. Create data masking function for sensitive fields (for potential future API exposure)
...
-- 7. Create trigger to prevent unauthorized email changes
...
-- 9. Add constraint to ensure user_id is always set (prevent NULL user_id vulnerability)
ALTER TABLE public.profiles 
ALTER COLUMN user_id SET NOT NULL;

-- 10. Create index for security logging performance
...
-- 11. Grant minimal necessary permissions
