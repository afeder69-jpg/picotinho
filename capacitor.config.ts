...
const config: CapacitorConfig = {
  ...
  appName: 'Picotinho',
  webDir: 'dist',
  // Remover server config para APK usar código local compilado
  // server: {
  ...
  android: {
    ...
    adaptiveIcon: {
      foreground: '/lovable-uploads/001d78d6-0621-4eee-a7c8-d55416f88f4f.png',
      background: '#FFFFFF'
    }
  },
  ios: {
    ...
    icon: '/lovable-uploads/001d78d6-0621-4eee-a7c8-d55416f88f4f.png'
  }
};
