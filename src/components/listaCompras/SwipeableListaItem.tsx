...
interface SwipeableListaItemProps {
...
const SwipeableListaItem: React.FC<SwipeableListaItemProps> = ({
  children,
  onSwipeRight,
  onSwipeLeft,
  disabled = false,
  ...
  return (
    <div className="relative overflow-hidden rounded-lg">
      {/* Right swipe background (remover) */}
      {translateX > 0 && (
        <div
...
export default SwipeableListaItem;
