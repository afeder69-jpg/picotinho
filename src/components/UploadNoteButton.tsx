    ...
    try {
      ...
      for (const file of Array.from(files)) {
        try {
          ...
          console.log('✅ Nota inserida no banco:', notaData.id);
          
          // 📤 Toast simples - Real-time fará o resto automaticamente
          toast({
            title: "📤 Nota enviada!",
            description: "Processando automaticamente em segundo plano...",
          });
